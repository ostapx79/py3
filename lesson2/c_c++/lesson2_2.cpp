...
int main()
{
    // Комментарий по арифметических операций можно найти в файле по Си
    // lesson2_2.c. 
    int a, b;
    a = 3;
    b = 4;
    ...
    // В С++ когда делишь целое число на целое число, и кладешь в переменой с
    ...
    // Засомневался, но все таки float = int / int; // result: int, интересно
