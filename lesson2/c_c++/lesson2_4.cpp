...
int main()
{
    ...
    cout.width(10);
    cout.precision(5);
    cout << x << endl; // выводит на консоль |....123.46, и округляет в большую сторону
    cout.width(10);
    cout.precision(2);
    cout << x << endl; // выводит на консоль |...1.2e+02, не могу пока это объяснять
    cout.width(10);
    cout.precision(3);
    ...
    // если в конце дробной части больше или равно 5 округляет в большую сторону
