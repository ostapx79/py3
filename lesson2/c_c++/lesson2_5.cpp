...
int main()
{
    ...
    // манипулировать доробной части.
    float a_1, a_2;
    a_1 = -1.6; // result: -1.6
    a_2 = 1.6; // result: 1.6
    std::cout << "a_1=" << a_1 << std::endl << "a_2=" << a_2 << std::endl;

    // В Си++ выводит целые числа, (int) преобразует в челое число, и не нужны
    // ни как манипуляции с дробной части как Си. Отбрасывание дробной части
    // происходит к нулю, что отрицательные так и положетельные числа.
    float b_1, b_2;
    b_1 = (int)-1.6;
    b_2 = (int)1.6;
