...
def number_in_words(number_words):
    switcher = {
        ...
        62: "шестьдесят два!", 63: "шестьдесят три!", 64: 'шестьдесят четыре!',
        65: 'шестьдесят пять!', 66: 'шестьдесят шесть!', 67: 'шестьдесят семь!',
        68: 'шестьдесят восемь!', 69: 'шестьдесят девять!', 70: 'семьдесят!',
        71: 'семьдесят один!', 72: 'семьдесят два!', 73: 'семьдесят три!',
        74: 'семьдесят четыре!', 75: 'семьдесят пять!', 76: 'семьдесят шесть!',
        77: 'семьдесят семь!', 78: "семьдесят восемь!", 79: 'семьдесят девять!',
        80: "восемьдесят!", 81: 'восемьдесят один!', 82: 'восемьдесят два!',
        83: 'восемьдесят три!', 84: 'восемьдесят четыре!', 85: 'восемьдесят пять!',
        ...
        98: 'девяносто восемь!', 99: 'девяносто девять!', 100: 'сто!',
        101: 'сто один!',
    }
    print(switcher.get(number_words, "Такого числа нет!"))


numb_n = int(input("Введите число -> "))
number_in_words(numb_n)
