...
int main() {
    ...
    // максимальное из трех чисел, записанных в переменные a, b и c:
    ...
    // Программа будет не корректно работать по той простой причине что будет
    // выводится на экран, не только максимальное значение переменной но и
    // переменной которая ваше не должна выводится. Напишем корректную программу.
