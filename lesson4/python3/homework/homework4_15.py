...
# Напишите программу, корая определяет, верно ли, что введеное число содержет
# две одинаковые цыфры, стоящие рядом (221 или 122).
...
if entered_numb > 0 and entered_numb < 100:
    ...
    if result1 == result2:
        print("Первые числа совпадют друг с другом.")
    else:
        print("Первые числа не совпадают друг с другом.")
